...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(90524);
...
async function main() {
  const mimeExtensionsMods = [
    __webpack_require__(44219),
    __webpack_require__(65749),
    __webpack_require__(10654),
    __webpack_require__(44830),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(25265),
  __webpack_require__(90199),
  __webpack_require__(97736),
  __webpack_require__(71197),
  __webpack_require__(87785),
  __webpack_require__(94919),
  __webpack_require__(32680),
  
      (__webpack_require__(90567)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(59642)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(96448),
  
      (__webpack_require__(12181)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(78059)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      (__webpack_require__(6588)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(73441)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(64571)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(3481)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(82339)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(41908),
  __webpack_require__(83110),
  __webpack_require__(56720),
  
      (__webpack_require__(64503)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(66985),
  __webpack_require__(81279),
  __webpack_require__(88911),
  
      (__webpack_require__(73669)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(64836),
  __webpack_require__(65515),
  __webpack_require__(89475),
  __webpack_require__(6606),
  __webpack_require__(82018),
  __webpack_require__(77716),
  __webpack_require__(79208),
  __webpack_require__(82601),
  __webpack_require__(43107),
  __webpack_require__(60500),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      (__webpack_require__(56940)["default"].filter)(({id}) => [
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(47587),
  __webpack_require__(51119),
  
      (__webpack_require__(47889)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(94405)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(46171)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(1753).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(16488).IServiceManager);
...
//# sourceMappingURL=8781.8d9955710c04c689f0cd.js.map?v=8d9955710c04c689f0cd