...
`,styles:(e,t)=>_l`
  ...
  `.withBehaviors(Il(_l`
    ...
    <template
        ...
        ${n={property:"childItems",attributeFilter:["disabled","hidden"],filter:wl(),subtree:!0},"string"==typeof n&&(n={property:n}),new Da("fast-children",iu,n)}
    >
        <slot name="label"></slot>
        <div class="positioning-region" part="positioning-region">
            ${al(0,t)}
            <slot
                ${Cl({filter:wl(),property:"slottedItems"})}
            ></slot>
            ${ol(0,t)}
        </div>
    </template>
